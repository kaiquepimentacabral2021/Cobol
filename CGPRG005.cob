      ...
      *=======================*
       PROGRAM-ID.   CGPRG005.
       AUTHOR.        THIAGO VALERO - KAIQUE PIMENTA.
       INSTALLATION.  FATEC SAO CAETANO.
       DATE-WRITTEN.  18/04/2025.
       DATE-COMPILED. 23/04/2025.
      ...
      *-----> VARIAVEIS AUXILIARES UTILIZADA NO PROCESSAMENTO
       01  WS-AREA-AUX.
           ...
           05  AS-HIFENS              PIC X(80) VALUE ALL '-'.
      ...
      *--------------------------------------------------------------*
       010-INICIAR.
           ...
           DISPLAY AS-HIFENS
           DISPLAY 'ATIVIDADE 5'
           DISPLAY 'THIAGO VALERO - KAIQUE PIMENTA'
      ...
      *--------------------------------------------------------------*
       090-TERMINAR.
           ...
           DISPLAY ' * TOTAL DE ALUNOS COM MEDIA < 6,00:' WS-COUNT-SIX
           DISPLAY ' * % DE ALUNOS COM MEDIA < 6,00:' WS-PERCENT-SIX '%'
           DISPLAY ' *========================================*'
           DISPLAY ' *----------------------------------------*'
